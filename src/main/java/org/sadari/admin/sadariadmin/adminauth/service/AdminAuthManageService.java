 ...
 */public interface AdminAuthManageService {
    ...
    /** 관리자 권한 부여 화면 데이터 조회 */
    AdminAuthManageVO getAdminAuthManage(int pageNumber, AdminSessionVO admin);

    /** 관리자 권한 일괄 수정 */
    AdminAuthManageVO uptAdminAuthList(List<AdminAuthVO> admins, int pageNumber, AdminSessionVO admin);
}
